 ...
 * ```
 */
export interface DrashResponse {
  body_init: BodyInit;
   ...
   */
  status(
    status: number | Types.HTTPStatusCode | Types.HTTPStatusCodeEnum,
  ): this;
...
export interface ErrorHandler extends Handler {
  ...
  ) => Types.Promisable<DrashResponse | void>;
}
...
export interface Resource {
  ...
  CONNECT(
    request: DrashRequest,
    response: DrashResponse,
  ): Types.Promisable<DrashResponse>;
