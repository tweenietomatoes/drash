...
import { DrashResponse } from "../http/drash_response.ts";
...
import { StatusCode as HTTPStatusCode } from "../dictionaries/http.ts";
...
export abstract class AbstractRequestHandler extends ChainHandler
  ...
  public handle(incomingRequest: Request): Types.Promisable<Response> {
    ...
    return Promise
      ...
      .then(() => (context.response as DrashResponse).toNativeResponse());
  }
